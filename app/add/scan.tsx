  ...
  if (!permission.granted) {
    return (
      <SafeAreaView style={styles.center}>
        <Text style={styles.permText}>Accès caméra requis pour scanner</Text>
...
const styles = StyleSheet.create({
  ...
  scanCornerTL: { ...CORNER, top: 0, left: 0, borderTopWidth: 3, borderLeftWidth: 3 },
  scanCornerTR: { ...CORNER, top: 0, right: 0, borderTopWidth: 3, borderRightWidth: 3 },
  scanCornerBL: { ...CORNER, bottom: 0, left: 0, borderBottomWidth: 3, borderLeftWidth: 3 },
  scanCornerBR: { ...CORNER, bottom: 0, right: 0, borderBottomWidth: 3, borderRightWidth: 3 },
  bottom: {
    alignItems: 'center',
  ...
  permText: { color: colors.text, fontSize: fontSize.lg, marginBottom: spacing.lg },
  permButton: {
  ...
  permButtonText: { color: colors.text, fontSize: fontSize.md, fontWeight: '600' },
